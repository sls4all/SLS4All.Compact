...
namespace SLS4All.Compact.Temperature
{
    public interface IHalogenClient
    {
        ...
        ValueTask SetHalogens(bool enabled, int? mask = null, float? power = null, bool hidden = false, IPrinterClientCommandContext? context = null, CancellationToken cancel = default);
        ValueTask SetHalogens(Memory<(bool enabled, int index, float? power)> values, bool hidden, IPrinterClientCommandContext? context = null, CancellationToken cancel = default);
