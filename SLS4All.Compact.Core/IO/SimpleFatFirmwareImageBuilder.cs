...
{
    public static class SimpleFatFirmwareImageBuilder
    {
        public static Stream CreateImage(Stream firmware)
        {
            ...
            using (var templateGz = typeof(SimpleFatFirmwareImageBuilder).Assembly.GetManifestResourceStream("SLS4All.Compact.IO.SimpleFatFirmwareImageTemplate.img.gz")!)
